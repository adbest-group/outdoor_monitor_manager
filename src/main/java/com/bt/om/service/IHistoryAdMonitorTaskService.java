 ...
 */
public interface IHistoryAdMonitorTaskService {
	 ...
	 * @return 监测任务详情信息
	 */
	public AdMonitorTaskVo getTaskDetails(SearchDataVo svo);
	 ...
	 * @return 返回任务提交详情情况
	 */
	public List<AdMonitorTaskVo> getSubmitDetails(SearchDataVo svo);

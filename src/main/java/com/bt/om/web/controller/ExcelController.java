...
//        Document document = new Document(PageSize.LEDGER);
        ...
        try {
		    ...
		    BaseFont secfont = BaseFont.createFont("c:/Windows/fonts/SIMKAI.TTF", BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED);
		    BaseFont thifont = BaseFont.createFont("c:/Windows/fonts/SIMFANG.TTF", BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED);

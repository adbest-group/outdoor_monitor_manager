            ...
            for (int i = 1; i < listob.size(); i++) {
                ...
                if(lo.size() <= 19){
                	...
                	if(lo.get(0) == null) {
                		...
                		info.setName(String.valueOf(lo.get(0)).trim().replaceAll("\n", "")); //广告位名称
                		lo.set(0,String.valueOf(lo.get(0)).trim().replaceAll("\n", ""));
                	}
                	...
                	if(hasProblem == false) {
                		if(lo.get(1) == null) {
                    		lo.set(17, IMPORT_FAIL);
                    		lo.set(18, ExcelImportFailEnum.MEDIA_NULL.getText());
                    		hasProblem = true;
                    	} else {
                    		for (AdMedia adMedia : allMedias) {
                    			if(StringUtil.equals(adMedia.getMediaName(), String.valueOf(lo.get(1)).trim())) {
                	...
                	if(hasProblem == false) {
                		if(lo.get(3) == null) {
                    		...
                    		String parentName = String.valueOf(lo.get(2)).trim();
                    		String secondName = String.valueOf(lo.get(3)).trim();
                	...
                	if(hasProblem == false) {
                		if(lo.get(4) == null) {
                    		...
                    		String provinceName = String.valueOf(lo.get(4)).trim(); //省
                    		//判断是否是直辖市
                	...
                	if(hasProblem == false) {
                		if(lo.get(5) == null) {
                    		...
                    		if(zhiXiaShiFlag == true) {
                    			...
                    			String cityName = String.valueOf(lo.get(5)).trim(); //市
                        		if(zhiXiaShiFlag == true) {
                	...
                	if(hasProblem == false) {
                		if(lo.get(6) == null) {
                    		...
                    		String road = String.valueOf(lo.get(6)).trim(); //主要路段
                    		info.setRoad(road);
                    		buffer.append(road);
                    	}
                	}
                	...
                	if(hasProblem == false) {
                		if(lo.get(7) == null) {
                    		...
                    		info.setLocation(String.valueOf(lo.get(7)).trim().replaceAll("\n", "")); //详细位置
                    		buffer.append(String.valueOf(lo.get(7)).trim().replaceAll("\n", ""));
                    		lo.set(7, String.valueOf(lo.get(7)).trim().replaceAll("\n", ""));
                    	}
                	}
                	...
                	if(hasProblem == false) {
                		if(lo.get(8) != null) {
                			...
                			if(memoSet.contains(memo) == true) {
                				lo.set(17, IMPORT_FAIL);
                        		lo.set(18, ExcelImportFailEnum.MEMO_DUP.getText());
                        		hasProblem = true;
                			} else {
                				info.setMemo(memo);
                				memoSet.add(memo);
...
//                    		DecimalFormat df = new DecimalFormat("0"); // 格式化number String字符
                    		String length = String.valueOf(lo.get(9)).trim();
                    		String width = String.valueOf(lo.get(10)).trim();
...
//                	}
                	...
                	if(hasProblem == false) {
                		if(lo.get(11) != null) {
                			Double b = Double.parseDouble(String.valueOf(lo.get(11)).trim());
                	...
                	if(hasProblem == false) {
                		if(lo.get(15) != null) {
                    		info.setContactName(String.valueOf(lo.get(16)).trim());
                    	}
                	}
                	...
                	if(hasProblem == false) {
                		if(lo.get(16) != null) {
                    		info.setContactCell(String.valueOf(lo.get(17)).trim());
                    	}
                	}
		...
		try {
            ...
            for (int i = 1; i < listob.size(); i++) {
                ...
                if(lo.size() <= 18){
                	...
                	//设置广告位名称
                	if(lo.get(0) == null) {
                		lo.set(16, IMPORT_FAIL);
                		lo.set(17, ExcelImportFailEnum.ADNAME_NULL.getText());
                		hasProblem = true;
                	} else {
                		info.setName(String.valueOf(lo.get(0)).trim().replaceAll("\n", "")); //广告位名称
                		lo.set(0, String.valueOf(lo.get(0)).trim().replaceAll("\n", ""));
                	...
                	if(hasProblem == false) {
                		if(lo.get(1) == null) {
                    		lo.set(16, IMPORT_FAIL);
                    		lo.set(17, ExcelImportFailEnum.PARENT_NULL.getText());
                    		hasProblem = true;
                    	}
                	}
                	...
                	if(hasProblem == false) {
                		if(lo.get(2) == null) {
                    		lo.set(16, IMPORT_FAIL);
                    		lo.set(17, ExcelImportFailEnum.SECOND_NULL.getText());
                    		hasProblem = true;
                    	} else {
                    		...
                    		if(adMediaTypeVo != null) {
                    			...
                    			lo.set(16, IMPORT_FAIL);
                        		lo.set(17, ExcelImportFailEnum.MEDIA_TYPE_INVALID.getText());
                        		hasProblem = true;
                    		}
    					}
                	}
...
//                	}
                	...
                	if(hasProblem == false) {
                		if(lo.get(3) == null) {
                    		lo.set(16, IMPORT_FAIL);
                    		lo.set(17, ExcelImportFailEnum.PROVINCE_NULL.getText());
                    		hasProblem = true;
                    	} else {
                    		...
                    		if(provinceId == null) {
                    			lo.set(16, IMPORT_FAIL);
                        		lo.set(17, ExcelImportFailEnum.PROVINCE_INVALID.getText());
                        		hasProblem = true;
                    		}
                    		info.setProvince(provinceId);
                    		buffer.append(provinceName);
                	...
                	if(hasProblem == false) {
                		if(lo.get(4) == null) {
                    		if(zhiXiaShiFlag == false) {
                    			lo.set(16, IMPORT_FAIL);
                        		lo.set(17, ExcelImportFailEnum.CITY_NULL.getText());
                        		hasProblem = true;
                    		}
                    	} else {
                    		if(zhiXiaShiFlag == true) {
                        		...
                        		if(zhiXiaShiFlag == true) {
                            		...
                            		if(cityId == null) {
                            			lo.set(16, IMPORT_FAIL);
                                		lo.set(17, ExcelImportFailEnum.CITY_INVALID.getText());
                                		hasProblem = true;
                            		}
                            		info.setCity(cityId);
                            		buffer.append(cityName);
...
//                	
                	...
                	if(hasProblem == false) {
                		if(lo.get(5) == null) {
                    		lo.set(16, IMPORT_FAIL);
                    		lo.set(17, ExcelImportFailEnum.STREET_NULL.getText());
                    		hasProblem = true;
                    	} else {
                    		String road = String.valueOf(lo.get(5)).trim(); //主要路段
                    		info.setRoad(road);
                    		buffer.append(road);
                    	}
                	}
                	...
                	if(hasProblem == false) {
                		if(lo.get(6) == null) {
                    		lo.set(16, IMPORT_FAIL);
                    		lo.set(17, ExcelImportFailEnum.LOCATION_NULL.getText());
                    		hasProblem = true;
                    	} else {
                    		info.setLocation(String.valueOf(lo.get(6)).trim().replaceAll("\n", "")); //详细位置
                    		buffer.append(String.valueOf(lo.get(6)).trim().replaceAll("\n", ""));
                    		lo.set(6, String.valueOf(lo.get(6)).trim().replaceAll("\n", ""));
                    	}
                	}
                	...
                	if(hasProblem == false) {
                		if(lo.get(7) != null) {
                			...
                			if(memoSet.contains(memo) == true) {
                				lo.set(16, IMPORT_FAIL);
                        		lo.set(17, ExcelImportFailEnum.MEMO_DUP.getText());
                        		hasProblem = true;
                			} else {
                				info.setMemo(memo);
                				memoSet.add(memo);
...
//                	}
                	...
                	//设置广告位尺寸
                	if(hasProblem == false) {
                		if(lo.get(8) != null && lo.get(9) != null) {
//                    		DecimalFormat df = new DecimalFormat("0"); // 格式化number String字符
                    		String length = String.valueOf(lo.get(8)).trim();
                    		String width = String.valueOf(lo.get(9)).trim();
                    		info.setAdSize(length + "*" + width); //广告位长度*广告位宽度
                    		lo.set(8, length);
                    		lo.set(9, width);
                    		double area = NumberUtil.divideInHalfUp(NumberUtil.multiply(width, length).toString(),"10000" , 3).doubleValue();
                    		...
                    		lo.set(16, IMPORT_FAIL);
                    		lo.set(17, ExcelImportFailEnum.SIZE_ONLYONE.getText());
                    		hasProblem = true;
    					} else if (lo.get(8) == null && lo.get(9) != null) {
                    		lo.set(16, IMPORT_FAIL);
                    		lo.set(17, ExcelImportFailEnum.SIZE_ONLYONE.getText());
...
//                	}
                	...
                	if(hasProblem == false) {
                		if(lo.get(10) != null) {
                			Double b = Double.parseDouble(String.valueOf(lo.get(10)).trim());
                    		info.setAdNum((new Double(b)).intValue());
                    	}
                	}
                	...
                	if(hasProblem == false) {
                		if(lo.get(11) != null && lo.get(12) == null) {
                    		lo.set(16, IMPORT_FAIL);
                    		lo.set(17, ExcelImportFailEnum.LOC_ONLYONE.getText());
                    		hasProblem = true;
                    	} else if (lo.get(11) == null && lo.get(12) != null) {
                    		lo.set(16, IMPORT_FAIL);
                    		lo.set(17, ExcelImportFailEnum.LOC_ONLYONE.getText());
                    		hasProblem = true;
    					} else if (lo.get(11) == null && lo.get(12) == null) {
    						...
    						//判断经度在-180-180之间
    						double lon = Double.parseDouble(String.valueOf(lo.get(11)).trim());
    						if(lon < -180 || lon > 180) {
    							lo.set(16, IMPORT_FAIL);
    	                		lo.set(17, ExcelImportFailEnum.LON_OVERFLOW.getText());
    	                		hasProblem = true;
    						}
    						//判断纬度在-90-90之间
    						double lat = Double.parseDouble(String.valueOf(lo.get(12)).trim());
    						if(lat < -90 || lat > 90) {
    	                		lo.set(16, IMPORT_FAIL);
    	                		lo.set(17, ExcelImportFailEnum.LAT_OVERFLOW.getText());
    	                		hasProblem = true;
    						}
    						info.setLon(lon); //经度
    	                	info.setLat(lat); //纬度
    	                	...
    	                	if(hasProblem == false) {
    	                		if(lo.get(13) != null) {
    	                			if(String.valueOf(lo.get(13)).trim().contains("百度")) {
    	                				info.setMapStandard(MapStandardEnum.getId("百度"));
    	                			} else if(String.valueOf(lo.get(13)).trim().contains("高德")) {
    	                				info.setMapStandard(MapStandardEnum.getId("高德"));
    	                			} else if(String.valueOf(lo.get(13)).trim().contains("谷歌")) {
    	                				info.setMapStandard(MapStandardEnum.getId("谷歌"));
    	                			}
        	                	} else {
        	                		lo.set(16, IMPORT_FAIL);
        	                		lo.set(17, ExcelImportFailEnum.NONE_MAP.getText());
        	                		hasProblem = true;
        						}
    	                	}
    					}
                	...
                	if(hasProblem == false) {
                		if(lo.get(14) != null) {
                    		info.setContactName(String.valueOf(lo.get(14)).trim());
                    	}
                	}
                	...
                	if(hasProblem == false) {
                		if(lo.get(15) != null) {
                    		info.setContactCell(String.valueOf(lo.get(15)).trim());
                    	}
                	}
                	...
                	if(hasProblem == false) {
                		if(keySet.contains(buffer.toString())) {
                    		lo.set(16, IMPORT_FAIL);
                    		lo.set(17, ExcelImportFailEnum.LOC_DUP.getText());
                    		hasProblem = true;
                    	} else {
                    		keySet.add(buffer.toString());
                    	}
                	...
                	if(!(StringUtils.equals(String.valueOf(lo.get(16)), IMPORT_FAIL))) {
                		//导入成功
                		lo.set(16, IMPORT_SUCC);
                		//默认没有贴上二维码
                		info.setCodeFlag(0);

...
public class JPushUtils {
	...
	public static String pushAllByTag(Map<String, Object> param) {
		return push(Platform.all(), Audience.tag((List)param.get("tags")), param);
	}
	/**
	...
	public static String pushAllByTagAnd(Map<String, Object> param) {
		return push(Platform.all(), Audience.tag_and((List)param.get("tag_and")), param);
	}
	/**
	 * 推送给所有平台的别名用户
	 * ---------------
	...
	public static String pushAllByAlias(Map<String, Object> param) {
		return push(Platform.all(), Audience.alias((List)param.get("alias")), param);
	}
	/**
	...
	public static String pushAllByRegistrationId(Map<String, Object> param) {
		return push(Platform.all(), Audience.registrationId((List)param.get("registration_id")), param);
	}
	...
	public static String pushAndroidByTag(Map<String, Object> param) {
		return push(Platform.android(), Audience.tag((List)param.get("tags")), param);
	}
	/**
	 * 推送给安卓平台的标签用户(需要同时在多个标签范围内)
	 */
	public static String pushAndroidByTagAnd(Map<String, Object> param) {
		return push(Platform.android(), Audience.tag_and((List)param.get("tag_and")), param);
	}
	/**
	 * 推送给安卓平台的别名用户
	 */
	public static String pushAndroidByAlias(Map<String, Object> param) {
		return push(Platform.android(), Audience.alias((List)param.get("alias")), param);
	}
	/**
	 * 推送给安卓平台的registrationId用户
	 */
	public static String pushAndroidByRegistrationId(Map<String, Object> param) {
		return push(Platform.android(), Audience.registrationId((List)param.get("registration_id")), param);
	}
	...
	public static String pushIOSByTags(Map<String, Object> param) {
		return push(Platform.ios(), Audience.tag((List)param.get("tags")), param);
	}
	/**
	 * 推送给IOS平台的标签用户(需要同时在多个标签范围内)
	 */
	public static String pushIOSByTagAnd(Map<String, Object> param) {
		return push(Platform.ios(), Audience.tag_and((List)param.get("tag_and")), param);
	}
	/**
	 * 推送给IOS平台的别名用户
	 */
	public static String pushIOSByAlias(Map<String, Object> param) {
		return push(Platform.ios(), Audience.alias((List)param.get("alias")), param);
	}
	/**
	 * 推送给IOS平台的registrationId用户
	 */
	public static String pushIOSByRegistrationId(Map<String, Object> param) {
		return push(Platform.ios(), Audience.registrationId((List)param.get("registration_id")), param);
	}
}

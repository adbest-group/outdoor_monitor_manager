...
<div class="main-container">
    <div class="main-box">
        ...
        <div style="width:100%;height:100%;margin-top:10px;">
            <div id="chart1"
                 style="float:left;width:60%;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;border:1px solid #aaa;">
            </div>
            <div id="chart2"
                 style="float:left;width:39%;margin-left:1%;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;border:1px solid #aaa;">
            </div>
            <div id="chart3"
                 style="float:left;width:39%;margin-left:1%;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;border:1px solid #aaa;margin-top:10px;">
            </div>
            <div style="clear:both;"></div>
            <div class="data-report"
                 style="float:left;width:60%;margin-top:10px;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;border:1px solid #aaa;">
                <div class="bd">
                    <table style="width:100%;" cellpadding="0" cellspacing="0" border="0" class="tablesorter">
                        <thead>
                        <tr>
                            <th>广告位</th>
                            <th>配套设施</th>
            ...
            <div id="map" style="float:left;width:39%;margin-top:10px;margin-left: 1%;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;border:1px solid #aaa;">
...
//        myChart.setOption(option);
        ...
        $("#chart1").height(parseInt($("#chart1").width() * 0.6));
        $("#chart2").height(parseInt(($("#chart1").height() - 10) * 0.5));
        $("#chart3").height($("#chart1").height() - 10 - $("#chart2").height());
        $("#map").height($(".bd").height());
        ...
        var option2 = {
            ...
            xAxis: {
                type: 'category',
                data: ["<18岁", "18-24", "25-29", "30-39", "40-49", "50-59", "60+"],
                axisLabel: {
                    interval: 0
                }
            },
            ...
            series: [{
                name: '男',
                type: 'line',
                data: [5, 30, 18, 20, 23, 15, 7]
            }, {
                name: '女',
                type: 'line',
                data: [9, 26, 22, 16, 27, 11, 7]
            }]
        };
        ...
        var option3 = {
            ...
            series: [{
                name: '人流量',
                type: 'line',
                data: [5000, 4000, 3500, 5500, 4500, 5000, 6500]
            }, {
                name: '人流量(私家车)',
                type: 'line',
                data: [1000, 1100, 900, 700, 800, 1000, 1200]
            }, {
                name: '人流量(公交车)',
                type: 'line',
                data: [100, 95, 90, 94, 101, 120, 130]
            }]
        };
        ...
        map.centerAndZoom(new BMap.Point(120.232156,30.213583), 16);  // 初始化地图,设置中心点坐标和地图级别
        //添加地图类型控件
...
//                BMAP_HYBRID_MAP
        ...
        map.addOverlay(new BMap.Marker(new BMap.Point(120.232156,30.213583),{}));

	...
	<div class="basic-info">
		<div class="bd">
            <form id="subForm" method="post">
                ...
                <input type="hidden" id="mediaId" value="${mediaId?if_exists}"/>
			<table width="100%" cellpadding="0" cellspacing="0" border="0" class="tablesorter">
				...
				<tr>
					<td class="a-title">&nbsp;</td>
					<td>
						<button type="button" class="btn btn-red" autocomplete="off" id="btnSave" style="margin-top: 100px;">确定</button>
					</td>
				</tr>
			</tbody>
		</table>
	...
	<script>
        ...
        $(function(){
            $("#btnSave").click(function () {
                parent.window.selectUserExecuteHandle($("#user").val(),$("#mediaId").val());
            });
        });
	</script>

<#assign webTitle="活动查看" in model>
<#assign webHead in model>
</#assign>
<@model.webhead />
    <!-- 头部 -->
    <@model.webMenu current="历史活动查看" child="活动查看" />
	<!-- 特色内容 -->
<div class="main-container" style="height: auto;">
    <div class="main-box">
        <div class="title clearfix">
            <div class="search-box search-ll" style="margin: 0 0 0 20px">
                <form id="form" method="get" action="/history/activity">
                    <!--活动搜索框-->
                     <div class="inp">
                    ...
                    <#if (bizObj.list?exists && bizObj.list?size>0) >
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <#if activity.status gt 0 ><a href="/history/activity/edit?id=${activity.id}">详情</a></#if>
                                <#if user.usertype !=6>
...
function changeMediaTypeId() {	
    ...
    $("#searchBtn").on("click", function () {
        ...
        window.location.href = "/history/activity" + strParam;
    });
...
//        $('.inputs-date').data('dateRangePicker').setDateRange(newDate,newDate, true);
    ...
    function openActivityExcel(activityId){
    	layer.open({
            ...
            shade: 0.8,
            area: ['600px', '420px'],
            content: '/history/activity/selectTaskToExcel?activityId=' + activityId //iframe的url
        });
    }
    ...
    function openActivityPdf(activityId){
    	layer.open({
            ...
            shade: 0.8,
            area: ['600px', '420px'],
            content: '/history/activity/selectTasksToPdf?activityId=' + activityId //iframe的url
        });
    }

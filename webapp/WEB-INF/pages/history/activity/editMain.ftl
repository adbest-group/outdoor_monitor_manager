            ...
            <div class="bd">
                ...
                <tr id="downMonitorLastDaysTr">
                 ...
                 -->
                		...
                		<#-- 监测任务图片数量 -->
	                    <tr>
                            <td class="a-title">监测任务最小上传图片数量：</td>
                            <td colspan="2">
                                <input type="text" id="picMinNum" ${editMode?string("","disabled")} name="picMinNum" value="" autocomplete="off" class="form-control" style="float:left;width: 100px;">
                                <span id="picMinNumTip"></span>
                            </td>
                        </tr>
                        <tr>
                            <td class="a-title">监测任务最大上传图片数量：</td>
                            <td colspan="2">
                                <input type="text" id="picMaxNum" ${editMode?string("","disabled")} name="picMaxNum" value="" autocomplete="off" class="form-control" style="float:left;width: 100px">
                                <span id="picMaxNumTip"></span>
                            </td>
                        </tr>
...
<script type="text/javascript">
	...
	<#if activity?exists>
	    var activity = {
	        ...
	        "picMinNum" : '${activity.monitorPicMinNum!""}',
	        "picMaxNum" : '${activity.monitorPicMaxNum!""}'
	    }
...
//                });
				...
				var picMinNum = $("#picMinNum").val();//监测任务最小可上传图片数量
				var picMaxNum = $("#picMaxNum").val();//监测任务最大可上传图片数量

        ...
        <#--</div>-->
                    ...
                    <div class="bor-box detail-demand">
                        ...
                        <#if task.status ==1>
                            ...
                            <p style="text-align:center;">
                                ...
                                <button type="button" class="btn btn-red" style="margin-left:10px;" id="btnReject">拒绝
                                </button>
                            </p>
                        </#if>
                        </div>
            ...
            <#if (subs?exists && subs?size>0) >
                <#list subs as sub >
                    ...
                    <div class="bd">
                        <div class="bor-box detail-demand">
                            <div class="con">
                                <p>提交时间：${sub.feedbackCreateTime?if_exists}</p>
                                ...
                                <p>提交照片：
                                    <#if sub.picUrl1?exists><img style="vertical-align: top" src="${sub.picUrl1}" width="300"/></#if>
                                    &nbsp;&nbsp;&nbsp;
                                    <#if sub.picUrl2?exists><img style="vertical-align: top" src="${sub.picUrl2}" width="300"/></#if>
                                    <br/>
                                    <#if sub.picUrl3?exists><img style="vertical-align: top" src="${sub.picUrl3}" width="300"/></#if>
                                    &nbsp;&nbsp;&nbsp;
                                    <#if sub.picUrl4?exists><img style="vertical-align: top" src="${sub.picUrl4}" width="300"/></#if>
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <#else>
                <#if task.subCreated == 1>
                    <div class="hd mt-10"><h3>已创建复查监测子任务，目前还没有监测反馈 &nbsp;&nbsp;&nbsp;<a href="/task/list?pid=${task.id}&ptype=2">去查看任务</a></h3></div>

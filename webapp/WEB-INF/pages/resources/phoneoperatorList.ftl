...
<@model.webhead />
<!-- 头部 -->
<@model.webMenu current="账户管理" child="话务员账号管理" />
<div class="main-container" style="height: auto;">
    <div class="main-box ott-market">
        <div class="title clearfix">
            <a href="javascript:;" class="add-new-btn ll" id="add_phoneoperator"><i></i> 新建话务员账号</a>
            <div class="search-box search-ll" style="margin: 0 0 0 20px">
                <div class="inp">
                    <input type="text" value="${nameOrUsername?if_exists}" placeholder="请输入话务员名/登录账户" id="nameOrUsername"
                           name="nameOrUsername">
                </div>
...
$(window).resize(function() {
    ...
    $("#add_phoneoperator").on("click", function () {
        ...
        layer.open({
            ...
            shade: 0.8,
            area: ['600px', '480px'],
            content: '/sysResources/phoneoperatorEdit' //iframe的url
        });
    });
    ...
    function edit(id) {
        layer.open({
            ...
            shade: 0.8,
            area: ['600px', '480px'],
            content: '/sysResources/phoneoperatorEdit?id=' + id //iframe的url
        });
    }
    ...
    $("#searchBtn").on("click", function () {
        ...
        window.location.href = "/sysResources/phoneoperatorList" + strParam;
    });

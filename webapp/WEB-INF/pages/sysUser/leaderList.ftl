    ...
    <div class="main-box ott-market">
        <div class="title clearfix">
            ...
            <div class="search-box search-ll" style="margin: 0 0 0 20px">
                <div class="inp">
                    <input type="text" placeholder="请输入领导名称" value="${searchName?if_exists}" id="searchName" name="searchName">
                </div>
...
<script type="text/javascript">
    ...
    $("#searchBtn").on("click", function () {
        ...
        window.location.href = "/sysUser/leaderList" + strParam;
    });
    ...
    $("#add_leader").on("click", function () {
        ...
        layer.open({
            ...
            shade: 0.8,
            area: ['600px', '480px'],
            content: '/sysUser/addLeader' //iframe的url
        });
    });
    ...
    function edit(id) {
        layer.open({
            ...
            shade: 0.8,
            area: ['600px', '480px'],
            content: '/sysUser/leaderEdit?id=' + id //iframe的url
        });
    }

...
require(
    ...
    function chartName (ec){
        var myChartMap1 = ec.init(document.getElementById('chart_map1'));
        $.post(
        	'/monitor/getMap',
        	function(data){
        		...
        		if(provinces!=null){
	        		for(var i =0; i<provinces.length;i++){
	        			...
	        			if (i == 0) {
	        				displayMaxNum = provinces[i].displayNum;
	        			} else {
	        				if (provinces[i].displayNum > displayMaxNum) {
	        					displayMaxNum = provinces[i].displayNum
	        				}
	        			}
	        		}
        		...
        		/*if(citys!=null){
	        		for(var i =0; i<citys.length;i++){
	        			...
	        			if (i == 0) {
	        				displayMaxNum = citys[i].displayNum;
	        			} else {
	        				if (citys[i].displayNum > displayMaxNum) {
	        					displayMaxNum = citys[i].displayNum
	        				}
	        			}
	        		}
